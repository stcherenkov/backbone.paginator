  ...
  var PageableCollection = Backbone.PageableCollection = Backbone.Collection.extend({
    ...
    */
    getPage: function (index, options) {
      ...
      var pageModelsStart = pageStart - (fullCollection && fullCollection.offset || 0);
      var pageModelsEnd = pageStart + pageSize - (fullCollection && fullCollection.offset || 0);
      var pageModels = fullCollection && fullCollection.length && (_isUndefined(fullCollection.offset) || pageStart >= fullCollection.offset) ?
      ...
      if (mode != "server") {
        ...
        options.success = function (col, resp, opts) {
          ...
          if (mode == "client") fullCol.reset(models, opts);
            ...
            if (!_isUndefined(fullCol.offset) && fullCol.size() + models.length > store.length) {
