  ...
  var PageableCollection = Backbone.PageableCollection = Backbone.Collection.extend({
    ...
    */
    _makeFullCollection: function (models, options) {
      ...
      var properties = ["url", "model", "sync", "comparator", "offset"];
    ...
    */
    getPage: function (index, options) {
      ...
      console.log('page', pageNum, 'pagesize', pageSize);
      var pageStart = (firstPage === 0 ? pageNum : pageNum - 1) * pageSize;
      var pageModelsStart = pageStart - (fullCollection.offset || 0);
      var pageModelsEnd = pageStart + pageSize - (fullCollection.offset || 0);
      console.log(fullCollection.offset, state);
      console.log(fullCollection.models, pageModelsStart, pageModelsEnd);
      var pageModels = fullCollection && fullCollection.length && pageStart >= fullCollection.offset ?
        ...
        options.success = function (col, resp, opts) {
          ...
          if (mode == "client") fullCol.reset(models, opts);
            ...
            if (fullCol.size() + models.length > store.length) {
              ...
              console.log("need to remove " + (forward ? "tail" : "head"));
              fullCol.offset += (forward ? models.length : - models.length);
            }
